...
then
	#concatenating previous and cuurrent version to capture changes. Stored in a unique file with check timestamp
	...
	#updating current version of the file for the purpose of future changes checking
